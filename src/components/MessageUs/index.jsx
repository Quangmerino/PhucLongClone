...
import logo from "../../pages/Layouts/Header/slide/images/logo2.png";
import ButtonComponent from "../ButtonComponent";
import realSVG from "./svg/accuracySVG.svg";
...
export default function MessageUs() {
  ...
  return (
    <Popover className="fixed z-50 right-10 bottom-52" content={PopoverMessage}>
