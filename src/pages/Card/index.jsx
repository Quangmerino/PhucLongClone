...
export default function CardPage() {
    ...
    return (
        <div className="flex flex-col items-center gap-10 mb-64 pt-10">
            <HeaderContent breadcrumbs="Thông tin chương trình Thành viên" title="Thông tin chương trình Thành viên"/>
            <div className="flex flex-col items-center gap-4">
                <h2 className="text-[28px]">Để kích hoạt Thành viên Phúc Long vui lòng tham khảo tại đây:</h2>
